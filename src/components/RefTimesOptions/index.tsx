...
export function RefTimesOptions() {
    ...
    useEffect(() => {
        ...
        async function setData() {
            ...
            const data = await fetch(`http://127.0.0.1:8000/api/meteor/models-reftimes?longitude=${lon}&latitude=${lat}&from=${start}&to=${end}`).then(res => res.json())     
