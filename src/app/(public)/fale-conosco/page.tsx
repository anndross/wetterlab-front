  ...
  return (
    <main className="bg-zinc-100 w-full h-[calc(100vh-var(--header-height))] flex gap-10 items-start pt-[10%] justify-start px-default">
      <div className="w-1/2 gap-10 flex flex-col items-start">
        <h1 className="text-5xl leading-snug text-left text-cyan-950 font-semibold">
          Fale conosco!
          <br />
          A nossa equipe de vendas terá
          <br />o prazer de atender você!
        </h1>
      ...
      <div className="w-96 h-96 flex flex-col gap-10 items-center justify-center bg-white rounded-lg shandow-sm">
